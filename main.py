...
async def on_message(message):
    ...
    if message.author.id == 699320094119166064:
        ...
        reactions = [
            "<:Goodshyguy:1066108921821024286>", "<:IMG_1443:1049859940459753512>", "<:badshyguy:1066108822470537277>",
            "<:bruhbomb:1080233198681870336>", "<:cola:1049864677259223050>", "<:emoji_4:1050214684738994249>",
            "<:emoji_5:1050214697758097408>", "<:emoji_6:1050214712282984498>", "<:wafflesdum:1066104213177909258>",
            "<a:luigi:1049864795119177818>"
        ]
...
async def Char_slash(ctx: discord.ApplicationContext, character: discord.Option(str, autocomplete=discord.utils.basic_autocomplete(GetCharactersNames))):
    ...
    embed.add_field(name="Percentile: " + str(weightpercentile), value=('\n(out of 100 karts this one would be better than ' + str(weightpercentile) + ' of them)'), inline=True)
